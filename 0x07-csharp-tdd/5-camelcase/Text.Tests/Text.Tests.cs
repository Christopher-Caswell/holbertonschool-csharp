...
namespace Tests
{
    public class Tests
    {
        ...
        public void Test2()
        {
            Assert.AreEqual(3, Text.Str.CamelCase("pinguIsGreat"));
        }
        [Test]
        /// <summary>
        ...
        public void Test3()
        {
            Assert.AreEqual(5, Text.Str.CamelCase("are You Ready To Grumble"));
        }
        [Test]
        /// <summary>
        ...
        [Test]
        /// <summary>
        /// Tests the CamelCase method, one word
        /// </summary>
        public void Test6()
        {
            Assert.AreEqual(1, Text.Str.CamelCase("womp"));
        }
    }
}
